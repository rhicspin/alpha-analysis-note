...
This plot is consistent with the other plot of the same dependency, derrived from
the data from the same ASTAR Database, but using a different method\cite{schmidke_edep}.
...
In \cref{fig:gain_relations,fig:e_dl,fig:x_dl} there

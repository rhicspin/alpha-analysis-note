...
the machine. For the calibration purposes we use \americium{} and \gadolinium 
radioactive sources emitting $\alpha$-particles with energies $E_{\text{Am}} =
5.486~\text{MeV}$ and $E_{\text{Gd}} = 3.271~\text{MeV}$ respectively.

Starting April 3, 2013 calibration runs were taken automatically at the end of
every RHIC store immeditely after the beam dump. This approach gave us the
ability to track the changes in detector characteristics at a more precise
level than before. The analys of the data was performed with the {\tt cnipol}

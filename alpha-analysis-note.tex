...
beam and registering the scattered carbon ions with silicon detectors. The final
polarization value strongly depends on the correct measurement of the energy of
the recoil products by the detectors. In this note we present a study of the
silicon detector response to $\alpha$-particles employed to calibrate the
detectors.

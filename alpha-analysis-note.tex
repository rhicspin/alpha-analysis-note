...
taken before and after run13 showing much lower spread. This suggests that the
variation might be beam induced: for example, the beam may create charge on the
parts of the detectors and affect alpha measurements after the beam is gone.
...
estimated to be $\approx 35\text{ }\mu g/cm^2$.

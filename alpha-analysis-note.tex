...
penetration depth can be seen in \cref{subfig:stopping_power}.
Our stopping power plot is consistent with the other plot derrived from
the same ASTAR data using a different method\cite{schmidke_edep}.

...
from the \emph{CSDA range}\footnotemark values avaliable at the
...
then derrived from $E$ vs $z_i$ points using simple numerical differentiation formula
...
This plot is consistent with the other plot\cite{schmidke_edep} of the same dependency, derrived from
